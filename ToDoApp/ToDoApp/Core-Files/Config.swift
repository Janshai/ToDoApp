...
struct Config {
    ...
    public static let categoryColours: [(name: CategoryColours, colour: UIColor)] =
        [(.white, #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)),
         ...
         (.lightGreen, #colorLiteral(red: 0.7474637365, green: 0.9485365724, blue: 0.3389681221, alpha: 1)),
         ...
         (.yellow, #colorLiteral(red: 0.9686274529, green: 0.9623121273, blue: 0.07923989685, alpha: 1)),
